...
public class smartCarParkingFog {
    ...
    static int numOfCamerasPerArea1 = 20; //16, 32, 64...
    static double CAM_TRANSMISSION_TIME = 5;
    private static boolean CLOUD = true;//false
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            //Create App and specify the properties
    ...
    private static FogDevice addCamera(String id, int userId, String appId, int parentId) {
        ...
        sensor.setLatency(40.0);  // latency of connection between camera (sensor) and the parent Smart Camera is 40 ms
